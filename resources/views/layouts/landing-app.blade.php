                ...
                <div class="col-lg-12">
                    <div class="navigation" >
                        <nav class="navbar navbar-expand-lg navbar-light " >
                            <a class="navbar-brand" href="{{url('')}}"><img src="{{url('')}}/assets/images/logo.png" style="width: 120px;height: 100px"></a>

                            <a class="navbar-brand-2"  href="{{url('')}}"><img src="{{url('')}}/assets/images/logo.png" style="width: 120px;height: 100px""></a> <!-- logo -->
...
<footer class="footer-area">
    <div class="footer-bg">
        <div class="footer-left">
            <img src="{{url('')}}/assets/images/footer-left.svg" alt="">
        </div>
        <div class="footer-right">
            <img src="{{url('')}}/assets/images/footer-right.svg" alt="">
        </div>
    </div>
    <div class="container">
