            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="banner-content">
                        <h1 class="title">Becoming <span>A Dvd Repair Expert</span> Online</h1>
                        <p>Finding the perfect learning tool for Flash is a daunting task to any novice web developer.
                            One
                            can find help in a number of ways through books, friends and private tutors</p>
                        <ul>
                            <li><a class="main-btn" href="error.html">REGISTER YOUR WORK</a></li>
    ...
    <section class="sevices-area">
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6 col-sm-9">
                    <div class="sevices-item mt-30">
                        <svg xmlns="http://www.w3.org/2000/svg" width="60" height="49" viewBox="0 0 60 49">
                            <g fill="none">
                                <path fill="#3F3D56"
                                      d="M57.656 0H2.344C1.049 0 0 1.049 0 2.343v43.575c0 1.294 1.05 2.343 2.344 2.343h55.312c1.295 0 2.344-1.049 2.344-2.343V2.343C60 1.049 58.95 0 57.656 0zM23.125 4.686h13.75v11.598h-13.75V4.686zm-18.438 0h13.75v11.598H4.687V4.686zm50.626 38.89H4.687V20.968h50.626v22.606zm0-27.292h-13.75V4.686h13.75v11.598z"/>
                                <path fill="#FF4F4F"
                                      d="M32.458 32.814l8.709-8.706c.915-.914 2.399-.914 3.314 0 .915.916.915 2.399 0 3.314L34.115 37.783c-.915.915-2.4.915-3.315 0l-4.654-4.652-7.313 7.31c-.915.915-2.399.915-3.314 0s-.915-2.399 0-3.313l8.97-8.967c.915-.915 2.4-.914 3.315 0l4.654 4.653z"/>
                            </g>
                        </svg>
                        <h4 class="title">Friendly dashboard & Cool Interface.</h4>
                        <p>Finding the perfect learning tool for Flash is a daunting task to any novice web
                            developer.</p>
                ...
                <div class="col-lg-4 col-md-6 col-sm-9">
                    <div class="sevices-item item-3 mt-30">
                        <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 60 60">
                            <g fill="none">
                                <path fill="#FF4F4F"
                                      d="M23.48 42.5c-.378 0-.755-.112-1.075-.34-.588-.412-.89-1.122-.777-1.83l1.077-6.75-4.667-4.745c-.49-.503-.666-1.235-.443-1.902.22-.668.795-1.155 1.49-1.265l6.352-.99 2.838-6.093c.305-.663.992-1.063 1.7-1.085.725 0 1.385.418 1.695 1.073l2.877 6.072 6.356.948c.694.105 1.275.587 1.5 1.252.227.665.06 1.402-.43 1.905l-4.636 4.778 1.125 6.74c.118.71-.18 1.422-.765 1.837-.59.418-1.36.463-1.987.115l-5.672-3.105-5.648 3.145c-.282.163-.598.24-.91.24zm-.205-13.692l2.77 2.817c.417.425.607 1.023.512 1.61l-.617 3.873 3.177-1.77c.563-.313 1.248-.316 1.816-.005l3.194 1.75-.647-3.868c-.097-.588.09-1.188.505-1.615l2.75-2.835-3.733-.558c-.62-.092-1.15-.485-1.417-1.05l-1.598-3.37-1.574 3.38c-.263.568-.793.965-1.408 1.063l-3.73.578z"/>
                                <path fill="#3F3D56"
                                      d="M30 55C16.215 55 5 43.785 5 30S16.215 5 30 5s25 11.215 25 25-11.215 25-25 25zm0-46.25C18.282 8.75 8.75 18.282 8.75 30S18.282 51.25 30 51.25 51.25 41.718 51.25 30 41.718 8.75 30 8.75z"/>
                                <path fill="#3F3D56"
                                      d="M30 12.5c-1.035 0-1.875-.84-1.875-1.875v-8.75C28.125.84 28.965 0 30 0c1.035 0 1.875.84 1.875 1.875v8.75c0 1.035-.84 1.875-1.875 1.875z"/>
                                <path fill="#3F3D56"
                                      d="M30 12.5c-1.035 0-1.875-.84-1.875-1.875v-8.75C28.125.84 28.965 0 30 0c1.035 0 1.875.84 1.875 1.875v8.75c0 1.035-.84 1.875-1.875 1.875zM58.125 31.875h-8.75c-1.035 0-1.875-.84-1.875-1.875 0-1.035.84-1.875 1.875-1.875h8.75c1.035 0 1.875.84 1.875 1.875 0 1.035-.84 1.875-1.875 1.875zM30 60c-1.035 0-1.875-.84-1.875-1.875v-8.75c0-1.035.84-1.875 1.875-1.875 1.035 0 1.875.84 1.875 1.875v8.75C31.875 59.16 31.035 60 30 60zM10.625 31.875h-8.75C.84 31.875 0 31.035 0 30c0-1.035.84-1.875 1.875-1.875h8.75c1.035 0 1.875.84 1.875 1.875 0 1.035-.84 1.875-1.875 1.875z"/>
                            </g>
                        </svg>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-5">
                        <div class="advertiser-thumb animated wow fadeInLeft" data-wow-duration="1500ms"
                            ...
                            <img src="{{url('')}}/assets/images/advertiser-thumb-1.png" alt="">
                            <div class="thumb">
                                <img src="{{url('')}}/assets/images/advertiser-bar-1.png" alt="advertiser">
                            </div>
                    ...
                    <div class="col-lg-7">
                        <div class="advertiser-content pl-65">
                            <h4 class="title"><span>Get Best</span> Advertiser <span>In Your Side and left Pocket</span>
                            </h4>
            ...
            <div class="row brand-active">
                <div class="col-lg-3">
                    <div class="brand-item text-center">
                        <a href="error.html"><img src="{{url('')}}/assets/images/brand.png" alt=""></a>
                    </div> <!-- brand item -->
                </div>
                <div class="col-lg-3">
                    <div class="brand-item text-center">
                                    ...
                                    <div class="accrodion active  animated wow fadeInRight" data-wow-duration="1500ms"
                                        ...
                                        <div class="accrodion-inner">
                                            <div class="accrodion-title">
                                                <h4>What If They Let You Run The Hubble</h4>
                                            </div>
                                            <div class="accrodion-content">
                                                <div class="inner">
                                                    <p>When the weather outside warms up, the kitchen can be a terrible
                                                        place to be. There are many things you can do however, when it
                                                        comes
                                                        to cooking a nice home made meal that doesn’t require
                                                        traditional
                                                        stove top or oven cooking. Learn to utilize some of the lesser
                                                        heat
                                                        producing equipment in your kitchen, such as the crock pot, in
                                                        order
                                                        to truly beat the summer heat and keep your cool while preparing
                                                        a
                                                        nice hot meal for friends and family.</p>
                                                </div><!-- /.inner -->
                                            </div>
                                        </div><!-- /.accrodion-inner -->
                                    </div>
